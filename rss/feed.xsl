...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <div class="profile-card">
                            <div class="avatar-wrapper">
                                <div class="avatar-container">
                                    <img src="/img/avatar.webp" alt="Sliverkiss" class="avatar" />
                            ...
                            <div class="profile-info">
                                <h1 class="site-title">Sliverkiss Blog</h1>
                                <p class="site-subtitle">与你一起发现更大的世界</p>
                                <p class="site-bio">这里是 Sliverkiss 的个人博客，与你一起发现更大的世界</p>

                                <div class="social-links">
                                                    <a href="https://github.com/sliverkiss" target="_blank" class="social-btn github" title="Github">
                                                        <i class="ri-github-fill"></i>
                                                    </a>
                                                    <a href="mailto:tistzach@gmail.com" target="_blank" class="social-btn email" title="Email">
    ...
    阅读全文 <i class="ri-arrow-right-s-line"></i>
                    ...
                    <footer class="page-footer">
                        <p>Designed with <i class="ri-heart-3-fill heart-beat"></i> by Sliverkiss</p>
                        <p class="copyright">
